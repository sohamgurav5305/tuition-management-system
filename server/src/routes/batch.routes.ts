...
router.get('/', authorizeRoles('ADMINISTRATOR', 'ACCOUNTANT', 'TEACHER'), (req, res) => batchController.getAll(req, res));
router.get('/:id', authorizeRoles('ADMINISTRATOR', 'ACCOUNTANT', 'TEACHER', 'STUDENT'), (req, res) => batchController.getById(req, res));
