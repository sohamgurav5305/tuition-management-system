  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <PageHeader
        ...
        subtitle="Manage institute branding, academic session configuration, administrator security, and cloud backups."
        badge="Master Control"
      />

      {/* Navigation Tabs */}
      <div className="flex items-center gap-1.5 overflow-x-auto border-b border-slate-200/80 dark:border-slate-800 pb-2">
        {[
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  type="text"
                  className="w-full px-3 py-2 text-xs bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-900 dark:text-slate-100 font-semibold"
                />
              </div>
        ...
        {/* Tab 2: Academic Session */}
        {activeTab === 'academic' && (
          <div className="bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4">
            <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider">
              Academic Session & Currency Configuration
            </h3>
            ...
            <div className="space-y-4 max-w-md">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-500 font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-500 font-semibold"
                />
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: 'Notify guardians when a student is marked absent in daily rollcall.',
                },
                {
                ...
                {
                  title: 'Test Series Result Publication',
                  desc: 'Send scorecards and AIR rank notifications upon exam marks release.',
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between p-3.5 bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 rounded-xl"
                >
                  <div>
        ...
        {activeTab === 'system' && (
          <div className="bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800">
              <div>
                <h4 className="text-xs font-bold text-slate-900 dark:text-slate-100">
