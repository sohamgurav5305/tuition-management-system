...
export const StudentList: React.FC = () => {
  ...
  const columns: Column<Student>[] = [
    {
      ...
      cell: (s) => (
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 font-bold flex items-center justify-center text-xs overflow-hidden flex-shrink-0">
            {s.avatarUrl ? (
    ...
    },
    {
      ...
      cell: (s) => (
        <div className="text-xs">
          {s.batch ? (
            <span className="font-semibold text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-950/60 px-2 py-0.5 rounded-md border border-purple-200/60 dark:border-purple-800/60">
              {s.batch.name}
            </span>
          ) : (
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title="Students"
        subtitle="Manage student records, batch enrollment, attendance rates, and fee dues."
      ...
      <DataTable
        ...
        isLoading={loading}
        searchPlaceholder="Search student name, roll number, or phone..."
        searchableFields={['firstName', 'lastName', 'studentId', 'phone', 'email']}
        filters={
