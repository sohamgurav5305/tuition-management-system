...
export const LoadingSkeleton: React.FC<LoadingSkeletonProps> = ({ count = 5 }) => {
  return (
    <div className="w-full space-y-4 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm animate-pulse">
      <div className="h-8 bg-slate-200 dark:bg-slate-800 rounded-xl w-1/4 mb-6"></div>
